...
am__antfx_SOURCES_DIST = antfxapp.c test/test_supports.c
#am_antfx_OBJECTS = antfxapp.$(OBJEXT)
am_antfx_OBJECTS = test/test_supports.$(OBJEXT)
...
DIST_SOURCES = $(am__libantfx_la_SOURCES_DIST) \
	$(am__antfx_SOURCES_DIST)
...
ACLOCAL = ${SHELL} /home/blackjack/workspace/antfx/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/blackjack/workspace/antfx/missing autoconf
AUTOHEADER = ${SHELL} /home/blackjack/workspace/antfx/missing autoheader
AUTOMAKE = ${SHELL} /home/blackjack/workspace/antfx/missing automake-1.15
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/blackjack/workspace/antfx/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 1.0.0b
abs_builddir = /home/blackjack/workspace/antfx
abs_srcdir = /home/blackjack/workspace/antfx
abs_top_builddir = /home/blackjack/workspace/antfx
abs_top_srcdir = /home/blackjack/workspace/antfx
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/blackjack/workspace/antfx/install-sh
...
# lib source files
antfx_SOURCES = test/test_supports.c
...
test/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) test/$(DEPDIR)
	@: > test/$(DEPDIR)/$(am__dirstamp)
test/test_supports.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
...
include ./$(DEPDIR)/antfx.Plo
include ./$(DEPDIR)/antfxapp.Po
include ./$(DEPDIR)/list.Plo
include ./$(DEPDIR)/supports.Plo
include engines/$(DEPDIR)/fb_engine.Plo
include engines/$(DEPDIR)/sdl2_engine.Plo
include test/$(DEPDIR)/test_supports.Po
include widgets/$(DEPDIR)/font.Plo
include widgets/$(DEPDIR)/image.Plo
include widgets/$(DEPDIR)/window.Plo
...
distclean: distclean-am
	...
	-rm -rf ./$(DEPDIR) engines/$(DEPDIR) test/$(DEPDIR) widgets/$(DEPDIR)
	-rm -f Makefile
